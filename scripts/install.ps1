...
Copy-Item (Join-Path $artifactsRoot "app\*") $appTarget -Recurse -Force
Copy-Item (Join-Path $artifactsRoot "nativehost\*") $nativeHostTarget -Recurse -Force
Copy-Item (Join-Path $artifactsRoot "extension\*") $extensionTarget -Recurse -Force
